...
namespace MyServer.Web.Areas.ImageGallery.Controllers
{
    ...
    public class ImageController : BaseController
    {
        ...
        public ImageController(IUserService userService, IAlbumService albumService, IImageService imageService) : base(userService)
        {
        ...
        {
            var dates =
                (await this.imageService.GetAllAsync())
            ...
            return null;//this.View(new ImageListViewModel() { Type = Common.ImageListType.Date, Caption = dates.First().ToString("dd MMMM yyyy"), Data = dates.First() });
        }

        public async Task<IActionResult> GetImageListData(Common.ImageListType type = Common.ImageListType.Date, string data = null)
        {
